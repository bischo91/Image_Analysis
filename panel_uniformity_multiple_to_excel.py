...
pathstr = r"C:\Users\bisch\Desktop\Mattrix\QVGA Panel\JSR QVGA Panel\JSR QVGA #8_sprayed\photos\after encap_V_en_4V, V_Scan_4V, V_Data_Off_4V\Green + Red".replace("\\","/")
...
for j in range(0, len(imgfiles)):
    ...
    if img_detect == False and 'grid' not in filename:
